    ...
    home-manager.users.${config.athena.homeManagerUser} = { pkgs, ...}: {
      ...
      programs.bash = {
        ...
        bashrcExtra = ''
          ...
          [[ $1 != no-repeat-flag && -f /run/current-system/sw/share/blesh/ble.sh ]] && source /run/current-system/sw/share/blesh/ble.sh

          # --- Bash completion ---
          [[ $PS1 && -f /run/current-system/sw/share/bash-completion/bash_completion ]] && . /run/current-system/sw/share/bash-completion/bash_completion
