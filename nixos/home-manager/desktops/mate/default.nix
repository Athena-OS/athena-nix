...
in {
  config = lib.mkIf (config.athena.desktopManager == "mate") {
    ...
    home-manager.users.${config.athena.homeManagerUser} = { pkgs, ...}: {
      ...
      dconf.settings = {
        "org/gnome/shell".favorite-apps = [ "athena-welcome.desktop" "athena-mimikatz.desktop" "athena-powersploit.desktop" "seclists.desktop" "payloadsallthethings.desktop" "shell.desktop" "powershell.desktop" "codium.desktop" "firefox-esr.desktop" "cyberchef.desktop" "fuzzdb.desktop" "securitywordlist.desktop" "autowordlists.desktop" ];
